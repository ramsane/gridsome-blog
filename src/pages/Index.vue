<template>
  <Layout :home="true" class="bg-page">
    ...
    <div class="bg-dark lg:pb-32">
      <div
        class="space-y-2 md:flex flex-row-reverse mx-auto lg:max-w-screen-lg items-center"
      >
        <app-avatar
          class="w-full max-w-md mx-auto lg:max-w-lg animation-fadeIn-from-Right"
        />
        <app-typed-intro
          class="text-gray-300 text-center w-full max-w-md mx-auto h-16"
        />
      </div>
    </div>
    ...
    <div class="bg-content max-w-screen-xl mx-auto lg:-mt-24 rounded-t-md">
      ...
      <!-- all articles link -->
      <div
        class="text-center my-4 text-xl font-novaround"
  ...
  meta: [
    {
      ...
      content: "nYlNdornnIrHptDmIjlg_fsxE-VyeiO6Oxqf9LRDe6Q",
    },
  ],
  metaInfo: {
    title: "Portfolio",
